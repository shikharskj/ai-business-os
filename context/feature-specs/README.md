...
* `01-design-system.md` is complete. `02-project-foundation.md` is complete. Next implementable spec is `03-authentication-clerk.md`.
...
* Do not silently resolve Open Questions. Confirm them with the project owner before choosing a vendor, multi-user model, payment method set, or Clerk Organizations.
...
5. **Do not**
6. **Follow**
7. **Open questions** (with a confirmation pointer)
8. **Check when done**
