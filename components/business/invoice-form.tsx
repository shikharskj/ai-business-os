...
import { InvoiceDocumentPreview } from "@/components/business/invoice-document";
import {
...
function customerPlaceOfSupply(
  customer: InvoiceCustomerOption | undefined,
): string {
  if (!customer) {
    return "";
  }
...
function buildInitialInvoiceLines(
...
export function InvoiceForm({
  ...
  const [lines, setLines] = useState<LineDraft[]>(
    invoice
      ...
      : buildInitialInvoiceLines(products, initialProductId, initialLineIndex)
  );
  const [engineView, setEngineView] = useState<InvoiceDocumentView | null>(
    null,
  );
        ...
        return {
          ...
          discount:
            line.discount && line.discount !== "0"
              ? formatDraftMoney(line.discount)
              : "INR 0.00",
        };
      }),
    [lines, products],
        ...
        >
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              GST is calculated by the tax engine when you save. Do not enter
              tax amounts here.
            </p>
                    ...
                    <Combobox
                      ...
                      onValueChange={(productId) => {
                        ...
                        updateLine(index, {
                          productId,
                          unitPrice:
                            product?.sellingPriceMajor ?? line.unitPrice,
                        });
                      }}
